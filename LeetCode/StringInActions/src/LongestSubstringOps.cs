...
namespace StringInActions
{
    public class LongestSubstringOps
    {
        ...
        //
        // Time complexity:  O((M-N+1) * N). The worst case is O(M*N)
        ...
        // Space complexity: O(1), since the charIndex array has a fixed size of 128.
        //
        ...
        // <returns></returns>
        // 
        // Time complexity:  O(26 * N) = O(N), where N is the length of the string s.
        ...
        // Space complexity: O(1), since the charIndex array has a fixed size of 128.
        //
        public static string FindTheLongestSubstring(string s)
        {
        ...
        // an even number of times. That is, 'a', 'e', 'i', 'o', and 'u' must appear an
        ...
        // Space complexity: O(1)
        //
        public static int FindTheLongestSubstringWithEvenVowelCount(string s)
        {
            int prefixXOR = 0;
            ...
            charMap['i' - 'a'] = 4;
            charMap['o' - 'a'] = 8;
            charMap['u' - 'a'] = 16; // 0000 -> 1111

            var idxMap = new int[32];
            Array.Fill(idxMap, -1);
            ...
            for (int i = 0; i < s.Length; i++)
            {
                ...
                if (idxMap[prefixXOR] == -1 && prefixXOR != 0)
                    idxMap[prefixXOR] = i;

                maxLen = Math.Max(maxLen, i - idxMap[prefixXOR]);
            }
