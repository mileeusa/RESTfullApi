...
namespace TreeInActions.src
{
    public class BinarySearchTreeAncestorOps
    {
        ...
        // 
        // Time complexity: O(h), where h is the height of the tree, i.e.
        //                  O(log n) for balanced BST and O(n) for skewed BST.
        //
        // Space complexity: space comes from recursive stack depth, O(log n) for balanced BST and O(n) for skewed BST
        // 
        ...
        // 
        // Time complexity:  O(h), where h is the height of the tree, i.e. O(log n) for balanced BST and O(n) for skewed BST.
        //
        // Space complexity: iterative approach uses constant space, no recursive stack, just a few pointers (root, p, q).
        //                   i.e. O(1)
        //
