...
namespace InitializerInActions.src
{
    class Country
    {
    ...
    {
        public static void ListInitializer_Test()
        {
        ...
        public static void DictionaryInitializer_Test()
        {
        ...
        public static void StackInitializer_Test()
        {
            //
        ...
        public static void AnonymousInitializer_Test()
        {
            var player = new
            {
                Name = "John",
        ...
        public static void ListToDictionary_Test()
        {
